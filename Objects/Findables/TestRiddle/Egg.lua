local Egg = Class:extend()

function Egg:new(x,y,r,sx,sy,riddleText)
    self.name = "Egg"
...
function Egg:giveRiddleText()
    return self.riddleText
end

function Egg:giveColor()
    return self.color
end
