local Clippers = Class:extend()

function Clippers:new(x,y,r,sx,sy,riddleText)
    self.name = "Clippers"
...
function Clippers:update(dt)

end

function Clippers:givePosition()
    return{
        X = self.x,
        Y = self.y,
        width = self.width,
